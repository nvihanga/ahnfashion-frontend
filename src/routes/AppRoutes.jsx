            ...
            <Routes>
                ...
                <Route element={<MainLayout />}>
                    ...
                    <Route element={<InventoryRoute />}>
                        <Route path={ROUTES.PROTECTED.DASHBOARD.INVENTORY} element={<InventoryDashboard />} />
                        <Route path={ROUTES.PROTECTED.RAW_MATERIALS.LIST} element={<RawMaterialsList />} />
                        <Route path={ROUTES.PROTECTED.RAW_MATERIALS.ADD} element={<RawMaterialsAdd />} />
                    </Route>

                    {/* Admin-only Routes */}
                    <Route element={<AdminRoute />}>
                        <Route path={ROUTES.PROTECTED.DASHBOARD.ADMIN} element={<AdminDashboard />} />
                    </Route>

                    {/* Shared Sales/Admin Routes */}
                    <Route element={<SalesRoute />}>
                        <Route path={ROUTES.PROTECTED.DASHBOARD.SALES} element={<SalesDashboard />} />
                    </Route>
