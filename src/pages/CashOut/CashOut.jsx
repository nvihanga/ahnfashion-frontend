...
const CashOutForm = ({ refreshList }) => {
    ...
    const validateForm = () => {
        ...
        if (!cashOut.amount || isNaN(cashOut.amount)) errs.amount = "Valid amount is required";
    ...
    const handleSaveCashOut = async () => {
        ...
        try {
            ...
            enqueueSnackbar("Cash out recorded successfully!", { variant: "success" });
        ...
        <div className="w-full mt-10 px-10 space-y-5">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-4">
                    <Button variant="contained" color="primary" onClick={handleSaveCashOut}>Save</Button>
                    <Button variant="outlined" color="secondary" onClick={() => setCashOut(initialCashOutState)}>Clear</Button>
                </div>
            </div>
            ...
            <TextField
                ...
                InputProps={{ inputProps: { min: 0 }, startAdornment: <span style={{ marginRight: 4 }}>රු</span> }}
            />
            <TextField
                name="date"
                label="Date"
