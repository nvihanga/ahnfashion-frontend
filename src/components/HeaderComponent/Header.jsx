...
//                 `}
//             </style>
//             <header className={`header w-full h-[auto] py-2 ${context.isSidebarOpen ? 'pl-64' : 'pl-5'} pr-10 shadow-md bg-white flex items-center justify-between transition-all`}>
//                 <div className='part1'>
//                     <Button 
//                         className='mobile-menu-button !w-[40px] !h-[40px] !rounded-full !min-w-[40px] !text-[rgba(0,0,0,0.8)]' 
//                         onClick={toggleMobileMenu}
//                     >
//                         {context.isSidebarOpen ? <AiOutlineMenuFold className='text-[20px] text-[rgba(0,0,0,0.8)]' /> : <AiOutlineMenuUnfold className='text-[20px] text-[rgba(0,0,0,0.8)]' />}
//                     </Button>
//                 </div>
